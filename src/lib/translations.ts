export const translations = {
  es: {
    ...
    projectsData: [
      { title: 'API REST - Java Spring Boot', description: 'Microservicio con autenticación por sesiones, API Gateway y descubrimiento de servicios.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'Microservicios'], flags: ['API', 'Backend', 'Online'] },
  ...
  en: {
    ...
    projectsData: [
      { title: 'API REST - Java Spring Boot', description: 'Microservice with session-based auth, API Gateway and service discovery.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'Microservices'], flags: ['API', 'Backend', 'Online'] },
