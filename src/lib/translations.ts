export const translations = {
  es: {
    ...
    projectsData: [
      { title: 'Sistema de Gestión de Clientes', description: 'Microservicio con autenticación por sesiones, API Gateway y descubrimiento de servicios.', tags: ['Java', 'Spring Boot', 'Spring Cloud', 'Spring Security', 'Hibernate', 'PostgreSQL', 'Docker', 'AWS', 'API', 'CI/CD'], flags: ['Online'], imageUrl: '/loginpv.png' },
      { title: 'Procesamiento de Imágenes con IA', description: 'Aplicación web que elimina fondos de imágenes automáticamente usando un modelo pre-entrenado.', tags: ['Python', 'Flask', 'Docker', 'Cloud'], flags: ['Online'], imageUrl: '/backgroundremover.jpg', url: 'https://eraser-h6cota2n5a-uc.a.run.app/', target: '_blank' },
  ...
  en: {
    ...
    projectsData: [
      { title: 'Customer Management System', description: 'Microservice with session-based auth, API Gateway and service discovery.', tags: ['Java', 'Spring Boot', 'Spring Cloud', 'Spring Security', 'Hibernate', 'PostgreSQL', 'Docker', 'AWS', 'API', 'CI/CD'], flags: ['Online'], imageUrl: '/loginpv.png' },
      { title: 'Image Processing with AI', description: 'Web app that removes image backgrounds automatically using a pre-trained model.', tags: ['Python', 'Flask', 'Docker', 'Cloud'], flags: ['Online'], imageUrl: '/backgroundremover.jpg', url: 'https://eraser-h6cota2n5a-uc.a.run.app/', target: '_blank' },
