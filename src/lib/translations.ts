export const translations = {
  es: {
    ...
    projectsData: [
      { title: 'Sistema de Gestión de Clientes', description: 'Microservicio con autenticación por sesiones, API Gateway y descubrimiento de servicios.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'AWS', 'API', 'Backend'], flags: ['Online'] },
  ...
  en: {
    ...
    projectsData: [
      { title: 'Customer Management System', description: 'Microservice with session-based auth, API Gateway and service discovery.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'AWS', 'API', 'Backend'], flags: ['Online'] },
