export const translations = {
  es: {
    ...
    projectsData: [
      { title: 'Sistema de Gestión de Clientes', description: 'Microservicio con autenticación por sesiones, API Gateway y descubrimiento de servicios. Despliegue en EC2 con Docker e integración serverless con Lambda y DynamoDB.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'EC2', 'Lambda'], flags: ['API', 'Backend', 'Online'] },
  ...
  en: {
    ...
    projectsData: [
      { title: 'Customer Management System', description: 'Microservice with session-based auth, API Gateway and service discovery. Deployed on EC2 with Docker and serverless integration with Lambda and DynamoDB.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'EC2', 'Lambda'], flags: ['API', 'Backend', 'Online'] },
