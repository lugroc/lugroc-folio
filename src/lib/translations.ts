export const translations = {
  es: {
    ...
    projectsData: [
      ...
      { title: 'API de Inventario', description: 'CRUD de productos con persistencia PostgreSQL, autenticación por sesiones y despliegue en EC2. Gestionado desde el dashboard.', tags: ['Java', 'Spring Boot', 'Spring Security', 'Hibernate', 'PostgreSQL', 'Docker', 'AWS'], flags: ['Online'], imageUrl: '/ecommerce.jpg' },
    ],
  ...
  en: {
    ...
    projectsData: [
      ...
      { title: 'Inventory API', description: 'Product CRUD with PostgreSQL persistence, session-based auth, and EC2 deployment. Managed from the dashboard.', tags: ['Java', 'Spring Boot', 'Spring Security', 'Hibernate', 'PostgreSQL', 'Docker', 'AWS'], flags: ['Online'], imageUrl: '/ecommerce.jpg' },
    ],
