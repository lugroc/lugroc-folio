export const translations = {
  es: {
    ...
    projectsData: [
      { title: 'API REST - Java Spring Boot', description: 'Microservicio con autenticación por sesiones, API Gateway y descubrimiento de servicios. Despliegue en EC2 con Docker e integración serverless con Lambda y DynamoDB.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'EC2', 'Lambda'], flags: ['API', 'Backend', 'Online'] },
    ...
    education: { heading: 'Mi educación', items: [{ title: 'Ingeniería Civil Informática (5 semestres)', location: 'Universidad San Sebastian', description: '', date: '2019 - 2021' }] },
  ...
  en: {
    ...
    projectsData: [
      { title: 'API REST - Java Spring Boot', description: 'Microservice with session-based auth, API Gateway and service discovery. Deployed on EC2 with Docker and serverless integration with Lambda and DynamoDB.', tags: ['Java', 'Spring Boot', 'PostgreSQL', 'Docker', 'EC2', 'Lambda'], flags: ['API', 'Backend', 'Online'] },
    ...
    education: { heading: 'My education', items: [{ title: 'Ingeniería Civil Informática (5 semesters)', location: 'Universidad San Sebastian', description: '', date: '2019 - 2021' }] },
